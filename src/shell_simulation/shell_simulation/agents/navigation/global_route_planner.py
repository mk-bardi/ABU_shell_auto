...
from .route_graph import DiGraph, astar_path
...
class GlobalRoutePlanner(object):
    ...
    def _build_graph(self):
        """
        This function builds a graph representation of topology, creating several class attributes:
        - graph (route_graph.DiGraph): directed graph representing the world map, with:
            Node properties:
